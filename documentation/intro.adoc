...
We can also compute this measure using the https://neo4j.com/docs/graph-algorithms/current/algorithms/similarity-cosine[Cosine Similarity algorithm^] in the Neo4j Graph Algorithms Library.
...
We can also compute this measure using the https://neo4j.com/docs/graph-algorithms/current/algorithms/similarity-pearson[Pearson Similarity algorithm^] in the Neo4j Graph Algorithms Library.
